...
<script type="text/javascript">
	function change() {
		...
		location.href="/userAll?num=${pageMaker.criteria.num}&postNum=" + sel;
	}
</script>
						...
						<div class="card-body">
							<div class="table-responsive">
								<nav class="navbar navbar-expand-lg navbar-light bg-white">
									<div class="form-check">
										...
										<input type="radio" class="form-check-input" name="optionsRadios"
											id="optionsRadios1" checked="checked" onclick="location.href='/userAll?num=1&postNum=5'"> 일반회원
										</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
										<label class="form-check-label">
										 <input type="radio" class="form-check-input" name="optionsRadios"
										...
										<label class="form-check-label"> 
										<input type="radio" class="form-check-input" name="optionsRadios"
											id="optionsRadios1" onclick="location.href='/userBlackAll?num=1&postNum=5'"> 블랙리스트
										</label>
									</div>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<div class="row">
										<form method="get" name="search" action="/userAll">
											<table class="pull-right">
												<tr>
													...
													<td><button type="submit" id="searchButton" name="searchButton" class="btn btn-success" style="background-color: rgb(37, 214, 179);">검색</button></td>
												</tr>
											</table>
										</form>
									</div>
								...
								<table class="table table-bordered" id="dataTable" width="100%"	cellspacing="0">
                                    ...
                                    <tbody>
                                    <c:forEach var="IMHDTO" items="${userAll }">
                                        <tr>
									...
									<ul class="pagination">
										<c:if test="${pageMaker.prev }">
											<li class="active"><a class="page-link"
												...
												href="/userAll?num=${pageMaker.startPage - 1 }&postNum=${pageMaker.criteria.postNum}">Previous</a></li>
										</c:if>

										<c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="num">
											<li class="page-item">
													<a class="page-link" href="/userAll?num=${num }&postNum=${pageMaker.criteria.postNum}">${num }</a>
											</li>
										</c:forEach>
										...
										<c:if test="${pageMaker.next }">
											<li class="page-item"><a class="page-link"
												style="background-color: rgb(37, 214, 179); color: white;"
												href="/userAll?num=${pageMaker.endPage + 1 }&postNum=${pageMaker.criteria.postNum}">Next</a></li>
										</c:if>
									</ul>
								</div>
								<!-- 페이징.END -->
